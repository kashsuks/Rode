...
impl IconManager {
    ...
    fn load_embedded_asset(&self, path: &str) -> Option<Vec<u8>> {
        ...
        match asset_path {
            ...
            "icons/javascript.svg" => Some(include_bytes!("../assets/icons/javascript.svg").to_vec()),
            "icons/typescript.svg" => Some(include_bytes!("../assets/icons/typescript.svg").to_vec()),
            ...
            "icons/sql.svg" | "icons/database.svg" => Some(include_bytes!("../assets/icons/database.svg").to_vec()),
            ...
            "icons/xml.svg" | "icons/markup.svg" => Some(include_bytes!("../assets/icons/markup.png").to_vec()),
            ...
            "icons/coffeescript.svg" => Some(include_bytes!("../assets/icons/coffeescript.svg").to_vec()),
            ...
            "icons/handlebars.svg" => Some(include_bytes!("../assets/icons/handlebars.svg").to_vec()),
            ...
            "icons/powershell.svg" => Some(include_bytes!("../assets/icons/powershell.png").to_vec()),
            ...
            "icons/verilog-sys.svg" => Some(include_bytes!("../assets/icons/verilog-sys.svg").to_vec()),
            ...
            "icons/visualstudio.svg" => Some(include_bytes!("../assets/icons/visualstudio.svg").to_vec()),
            ...
            "icons/certificate.svg" => Some(include_bytes!("../assets/icons/certificate.png").to_vec()),
            "icons/editorconfig.svg" => Some(include_bytes!("../assets/icons/editorconfig.png").to_vec()),
            "icons/contributing.svg" => Some(include_bytes!("../assets/icons/contributing.png").to_vec()),
            ...
            "icons/actionscript.png" => Some(include_bytes!("../assets/icons/actionscript.png").to_vec()),
            ...
            "icons/coldfusion.png" => Some(include_bytes!("../assets/icons/coldfusion.png").to_vec()),
            ...
            "icons/pascal-project.png" => Some(include_bytes!("../assets/icons/pascal-project.svg").to_vec()),
            ...
            "icons/serverless.png" => Some(include_bytes!("../assets/icons/serverless.png").to_vec()),
            ...
            "icons/folders/default.svg" => Some(include_bytes!("../assets/icons/folders/default.svg").to_vec()),
            "icons/folders/default-open.svg" => Some(include_bytes!("../assets/icons/folders/default-open.svg").to_vec()),
            "icons/folders/src.svg" => Some(include_bytes!("../assets/icons/folders/src.svg").to_vec()),
            "icons/folders/src-open.svg" => Some(include_bytes!("../assets/icons/folders/src-open.svg").to_vec()),
            "icons/folders/tests.svg" => Some(include_bytes!("../assets/icons/folders/tests.svg").to_vec()),
            "icons/folders/tests-open.svg" => Some(include_bytes!("../assets/icons/folders/tests-open.svg").to_vec()),
            "icons/folders/node.svg" => Some(include_bytes!("../assets/icons/folders/node.svg").to_vec()),
            "icons/folders/node-open.svg" => Some(include_bytes!("../assets/icons/folders/node-open.svg").to_vec()),
            "icons/folders/git.svg" => Some(include_bytes!("../assets/icons/folders/git.svg").to_vec()),
            "icons/folders/git-open.svg" => Some(include_bytes!("../assets/icons/folders/git-open.svg").to_vec()),
            "icons/folders/images.svg" => Some(include_bytes!("../assets/icons/folders/images.svg").to_vec()),
            "icons/folders/images-open.svg" => Some(include_bytes!("../assets/icons/folders/images-open.svg").to_vec()),
            "icons/folders/build.svg" => Some(include_bytes!("../assets/icons/folders/build.svg").to_vec()),
            "icons/folders/build-open.svg" => Some(include_bytes!("../assets/icons/folders/build-open.svg").to_vec()),
            "icons/folders/bower.svg" => Some(include_bytes!("../assets/icons/folders/bower.svg").to_vec()),
            "icons/folders/bower-open.svg" => Some(include_bytes!("../assets/icons/folders/bower-open.svg").to_vec()),
            "icons/folders/app.svg" => Some(include_bytes!("../assets/icons/folders/app.svg").to_vec()),
            "icons/folders/app-open.svg" => Some(include_bytes!("../assets/icons/folders/app-open.svg").to_vec()),
            "icons/folders/views.svg" => Some(include_bytes!("../assets/icons/folders/views.svg").to_vec()),
            "icons/folders/views-open.svg" => Some(include_bytes!("../assets/icons/folders/views-open.svg").to_vec()),
            "icons/folders/services.svg" => Some(include_bytes!("../assets/icons/folders/services.svg").to_vec()),
            "icons/folders/services-open.svg" => Some(include_bytes!("../assets/icons/folders/services-open.svg").to_vec()),
            "icons/folders/styles.svg" => Some(include_bytes!("../assets/icons/folders/styles.svg").to_vec()),
            "icons/folders/styles-open.svg" => Some(include_bytes!("../assets/icons/folders/styles-open.svg").to_vec()),
            "icons/folders/i18n.svg" => Some(include_bytes!("../assets/icons/folders/i18n.svg").to_vec()),
            "icons/folders/i18n-open.svg" => Some(include_bytes!("../assets/icons/folders/i18n-open.svg").to_vec()),
            "icons/folders/db.svg" => Some(include_bytes!("../assets/icons/folders/db.svg").to_vec()),
            "icons/folders/db-open.svg" => Some(include_bytes!("../assets/icons/folders/db-open.svg").to_vec()),
            "icons/folders/cypress.svg" => Some(include_bytes!("../assets/icons/folders/cypress.svg").to_vec()),
            "icons/folders/cypress-open.svg" => Some(include_bytes!("../assets/icons/folders/cypress-open.svg").to_vec()),
            "icons/folders/jest.svg" => Some(include_bytes!("../assets/icons/folders/jest.svg").to_vec()),
            "icons/folders/jest-open.svg" => Some(include_bytes!("../assets/icons/folders/jest-open.svg").to_vec()),
            "icons/folders/next.svg" => Some(include_bytes!("../assets/icons/folders/next.svg").to_vec()),
            "icons/folders/next-open.svg" => Some(include_bytes!("../assets/icons/folders/next-open.svg").to_vec()),
            "icons/folders/bench.svg" => Some(include_bytes!("../assets/icons/folders/bench.svg").to_vec()),
            "icons/folders/bench-open.svg" => Some(include_bytes!("../assets/icons/folders/bench-open.svg").to_vec()),
            "icons/folders/layout.svg" => Some(include_bytes!("../assets/icons/folders/layout.svg").to_vec()),
            "icons/folders/layout-open.svg" => Some(include_bytes!("../assets/icons/folders/layout-open.svg").to_vec()),
            "icons/folders/theme.svg" => Some(include_bytes!("../assets/icons/folders/theme.svg").to_vec()),
            "icons/folders/theme-open.svg" => Some(include_bytes!("../assets/icons/folders/theme-open.svg").to_vec()),
            "icons/folders/vsc.svg" => Some(include_bytes!("../assets/icons/folders/vsc.svg").to_vec()),
            "icons/folders/vsc-open.svg" => Some(include_bytes!("../assets/icons/folders/vsc-open.svg").to_vec()),
